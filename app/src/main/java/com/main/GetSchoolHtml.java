...
public class GetSchoolHtml {
    ...
    public void Get()  {
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("__EVENTTARGET",apiConstant.menuOptions.get(APIConstants.option.Schedule.name()))
                ...
                .addFormDataPart("dnn$ctr7126$TimeTableView$ClassesList",Classes.get(apiConstant.Classes[6]).toString())
                .build();
        // יצירת בקשת HTTP
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                apiConstant.responseString = response.body().string();
                response.body().close();
